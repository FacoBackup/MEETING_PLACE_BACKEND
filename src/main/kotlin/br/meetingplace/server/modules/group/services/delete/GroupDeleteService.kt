...
object GroupDeleteService{
    fun delete(requester: String,data: RequestGroup, groupMemberDAO: GMI, groupDAO: GI): HttpStatusCode {
        return try{
            val member = groupMemberDAO.read(userID = requester, groupID = data.groupID)
