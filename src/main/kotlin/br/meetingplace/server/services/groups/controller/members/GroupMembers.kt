package br.meetingplace.server.services.groups.controller.members
...
class GroupMembers private constructor() {
    ...
    fun addMember(data: MemberOperator, rwCommunity: CommunityLSInterface, rwGroup: GroupLSInterface, rwUser: UserLSInterface) {
        val user = rwUser.load(data.login.email)
        val newMember = rwUser.load(data.memberEmail)
    ...
    fun changeMemberRole(data: MemberOperator, rwGroup: GroupLSInterface, rwUser: UserLSInterface) {
        val user = rwUser.load(data.login.email)
        val member = rwUser.load(data.memberEmail)
    ...
    fun removeMember(data: MemberOperator, rwGroup: GroupLSInterface, rwUser: UserLSInterface, rwCommunity: CommunityLSInterface) {
