package br.meetingplace.server.services.chat.controller.favorite
...
class FavoriteMessage private constructor()  {
    ...
    fun favoriteMessage(data: ChatSimpleOperator, rwUser: UserLSInterface, rwGroup: GroupLSInterface, rwCommunity: CommunityLSInterface, rwChat: ChatLSInterface){
