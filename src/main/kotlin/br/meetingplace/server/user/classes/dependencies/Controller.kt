package br.meetingplace.server.user.classes.dependencies

import br.meetingplace.server.user.classes.dependencies.profile.UserProfile
import br.meetingplace.server.user.classes.dependencies.profile.UserProfileInterface
import br.meetingplace.server.user.classes.dependencies.services.chat.UserChat
import br.meetingplace.server.user.classes.dependencies.services.chat.UserChatInterface
import br.meetingplace.server.user.classes.dependencies.services.community.UserCommunity
import br.meetingplace.server.user.classes.dependencies.services.community.UserCommunityInterface
import br.meetingplace.server.user.classes.dependencies.services.follow.UserFollow
import br.meetingplace.server.user.classes.dependencies.services.follow.UserFollowInterface
import br.meetingplace.server.user.classes.dependencies.services.group.UserGroups
import br.meetingplace.server.user.classes.dependencies.services.group.UserGroupsInterface
import br.meetingplace.server.user.classes.dependencies.services.notification.UserNotifications
import br.meetingplace.server.user.classes.dependencies.services.notification.UserNotificationsInterface
import br.meetingplace.server.user.classes.dependencies.services.topic.UserTopics
import br.meetingplace.server.user.classes.dependencies.services.topic.UserTopicsInterface
